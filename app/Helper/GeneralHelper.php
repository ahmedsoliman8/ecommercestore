...
function getParentShowOf($param)
{
    ...
    //dd(Cache::get('admin_side_menu')->pluck('children')->flatten());
...
function getNumbers()
{
    ...
    {
        //dd(session()->get['coupon']['code']);
        $coupon = ProductCoupon::whereCode(session()->get('coupon')['code'])->whereStatus(true)->first();
       // dd($coupon);
