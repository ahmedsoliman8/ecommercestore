...
@section('content')
                ...
                <div class="col-lg-6 text-lg-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-lg-end mb-0 px-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('customer.profile')}}">Profile</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="py-5">
        <div class="row">
                ...
                <form action="{{ route('customer.update_profile') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center mb-4">
                            ...
                            @else
                                <img src="{{ asset('assets/users/customer-2.png') }}" alt="{{ auth()->user()->full_name }}" class="img-thumbnail" width="120">
                            @endif
                        </div>
            ...
            <div class="col-lg-4">
                @include('partials.frontend.customer.sidebar')
            </div>
        </div>
    </section>
@endsection