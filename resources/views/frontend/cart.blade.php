                    ...
                    @empty
                      <tr>
                        <td class="pl-0 border-light" colspan="5">
                          <p class="text-center">No Items Found In Your Cart!</p>
                        </td>
                      </tr>
                  @endforelse
              ...
              <div class="card border-0 rounded-0 p-lg-4 bg-light">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center justify-content-between"><strong class="text-uppercase small font-weight-bold">Subtotal</strong><span class="text-muted small">${{Cart::subtotal()}}</span></li>
