<div>
        ...
        <div class="col-sm-5 pr-sm-0">
            <div class="border d-flex align-items-center justify-content-between py-1 px-3 bg-white border-white"><span class="small text-uppercase text-gray mr-4 no-select">Quantity</span>
                <div class="quantity">
                    ...
                    <input type="text" wire:model="quantity" class="form-control border-0 shadow-0 p-0"  value="1">
    ...
    <a wire:click="addToWishList()" class="btn btn-link text-dark p-0 mb-4" href="#"><i class="far fa-heart mr-2"></i>Add to wish list</a>
</div>
