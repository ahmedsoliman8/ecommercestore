                    ...
                    <div class="row align-items-stretch">
                        <div class="col-lg-6 p-lg-0">
                            ...
                            <a class="product-view d-block h-100 bg-cover bg-center"
                               ...
                               data-lightbox="productview" title="{{$productModal->name}}">
                            </a>
                            @else
                            <a class="d-none"
                               href="{{asset('assets/products/'.$media->file_name)}}"
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="p-5 my-md-4">
                                ...
                                <p class="text-small mb-4">{{$productModal->description}}</p>
                                <div class="row align-items-stretch mb-4">
                                    ...
                                    <div class="col-sm-5 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" wire:click="addToCart()">Add to cart</a></div>
                                </div><a class="btn btn-link text-dark p-0" wire:click="addToWishList()"><i class="far fa-heart mr-2"></i>Add to wish list</a>
                            </div>
                        </div>
                    </div>
                    @endif
